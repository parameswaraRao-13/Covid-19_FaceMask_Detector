...
img_dir=r'/home/ram/PycharmProjects/covid_mask/covid-19__face_mask_detection-dataset/COVID-19/training/images'
    ...
    for member in root.findall('object'):
        try:
            ...
            try:
                ...
                if name=='face':
                    f_n=c_imgs_without_mask+'/'+str(p)+filename
                    new_img.save(f_n)
                elif name=='face_mask':
                    f_n = c_imgs_with_mask + '/' + str(p) + filename
                    new_img.save(f_n)
